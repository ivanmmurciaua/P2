...
PRINCIPAL=./uncleOwen	# Nombre del ejecutable de la práctica
...
npruebasa=3	   # Número de pruebas a ejecutar del autocorrector
mata=./mata
...
g++ -Wall -g $PRINCIPAL.cc -o $PRINCIPAL 2> $tempfile
if [ $? -ne 0 ]; then
        cat $tempfile
